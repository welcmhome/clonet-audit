          ...
          <section className="audit-card">
            {step === "intro" && (
              <>
                ...
                <p>
                  Answer a few questions so we can understand how your
                  operations and systems currently run. This helps us determine
...
const styles = `
  ...
  .progress-track {
    ...
    height: 4px;
    border-radius: 999px;
    background: radial-gradient(circle at top, #e5e5e5, #d4d4d4);
  ...
  .results-preview {
    ...
    border-radius: 14px;
    border: 1px solid #e5e5e5;
    background: radial-gradient(circle at top, #f0f0f0, #e8e8e8);
  ...
  .results-preview::after {
    ...
    position: absolute;
    inset: 0;
    background: radial-gradient(circle at top right, rgba(248, 248, 248, 0) 0%, rgba(248, 248, 248, 0.95) 60%);
    pointer-events: none;
  }
  .checkbox-field {
    margin-top: 8px;
  ...
  @keyframes pixel-pulse {
    0%, 100% { background: #d4d4d4; opacity: 0.6; }
